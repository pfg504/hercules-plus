...
// $Id: w32mtio.h 7594 2011-07-18 23:16:59Z pgorlinsky $

////////////////////////////////////////////////////////////////////////////////////
//
//  From the Koders.com (http://www.koders.com/) entry for
//  the Unununium(uuu) project (http://unununium.org/) which,
//  believe it or not, states their source code is COMPLETELY
//  FREE (i.e. no licensing restrictions AT ALL!).
//  Modified as needed by Fish for Hercules Win32 port.
//  Original filename: mtio.h; new filename: w32mtio.h
//
////////////////////////////////////////////////////////////////////////////////////
...
#ifdef _MSVC_               // (Fish: only needed for MSVC)

//#include <sys/ioctl.h>    // (Fish: not needed)
#define  _IOWR  _IOW        // (Fish: see 'winsock2.h')
//__BEGIN_DECLS             // (Fish: not needed)
