...
//    U16 xid2_resv2;        // 0B
//    U8  xid2_tgnum;        // 0D
//    U32 xid2_sender_id;    // 0E
//    U8  xid2_flag2;        // 12
//    U8  xid2_option;       // 13
//    char  xid2_resv3[8];     // 14
//    U16 xid2_resv4;        // 1C
//    U8  xid2_dlc_type;     // 1E
//    U16 xid2_resv5;        // 1F
//    U8  xid2_mpc_flag;     // 21
//    U8  xid2_resv6;        // 22
//    U16 xid2_buf_len;      // 23
//    char xid2_buffer[ 255 - ( 13 * sizeof(U8) +
//                               2 * sizeof(U32) +
//                               4 * sizeof(U16) +
//                               8 * sizeof(char) ) ];
...
//    .xid2_flag1 = 0,
//    .xid2_fmtt  = 0,
//    .xid2_flag4 = 0x80,                   // compared to 0x40
//    .xid2_resv2 = 0,
//    .xid2_tgnum = 0,
//    .xid2_sender_id = 0,
//    .xid2_flag2 = 0,                      // Compared for 0x40
//    .xid2_option  = XID2_0,               // = 0x00, or XID2_7 = 0x07
//    .xid2_resv3 = "\x00",
//    .xid2_resv4 = 0,
//    .xid2_dlc_type  = XID2_READ_SIDE,     // = 0x04, or XID2_WRITE_SIDE = 0x05
//    .xid2_resv5 = 0,
//    .xid2_mpc_flag  = 0,
//    .xid2_resv6 = 0,
//    .xid2_buf_len = (MPC_BUFSIZE_DEFAULT - 35),  // = 65535 - 35
//  };
...
struct HRB
{
    ...
    u_int           numeric;            // Numerical address
                                        //   FALSE
                                        //   TRUE
    int             wantafam;           // Wanted address family
                                        ...
                                        //   AF_INET
                                        //   AF_INET6
    int             rv;                 // getaddrinfo() return value
